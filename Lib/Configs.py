...
class GlobalConfig(Config):
    def __init__(self):
        ...
        self.rc_host = self.raw_config["rc"]["host"]
        ...
        self.startpic_h = self.raw_config["start_img"]["height"]
        self.startpic_w = self.raw_config["start_img"]["weight"]
        self.start_showcolorword = self.raw_config["color_word"]["show"]
